        ...
        <div className="mx-10">
            ...
            <div>
                ...
                <div className='flex gap-3'>
                    <Link to='/addemployee'>
                        <div className='flex flex-col items-center justify-center bg-[#ECEDFE] rounded-lg w-[336px] h-[120px]'>
                    ...
                    <Link to="/view-modify-database">
                        <div className='flex flex-col items-center justify-center bg-[#ECEDFE] rounded-lg w-[336px] h-[120px]'>
                            ...
                            <p className='text-[#283093] text-xl leading-7 font-medium'>View/Modify Database</p>
                        </div>
                    </Link>
                </div>
            </div>
