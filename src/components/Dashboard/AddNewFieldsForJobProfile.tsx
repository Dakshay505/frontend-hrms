...
const AddNewFieldsForJobProfile = () => {
    ...
    const validateFieldName = (value: any) => {
        if (/^\d/.test(value)) {
            return "Field Name cannot start with a digit";
        }
        return true;
    };

    // Event handler to handle changes in the Field Name input
    ...
    return (
        <div className="mx-10">
            <div className="pt-8">
                <h1 className="text-2xl font-bold text-[#2E2E2E]">Add New Fields for Job Profile</h1>
            </div>
            <div className='mt-10'>
                            ...
                            return <div key={index} className='border border-solid border-[#B0B0B0] rounded-lg p-6 mt-6'>
                                <div key={element + 1} className='flex gap-10 mx-6'>
                                    <div className='flex flex-col gap-3'>
                                        ...
                                        <div>
                                            <input
                                                {...register(`fieldName${index + 1}`, { required: "Field name required", validate: validateFieldName })}
            ...
            <div className='mt-12'>
                <div>
                    <h1 className='text-2xl text-[#2E2E2E] font-bold'>Update Existing Custom Fields for Job Profiles</h1>
                </div>
                <form
...
export default AddNewFieldsForJobProfile