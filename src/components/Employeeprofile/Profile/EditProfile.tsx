...
import { getSingleEmployeeAsync, newPasswordAsync, updateEmployeeAsync } from "../../../redux/Slice/EmployeeSlice"
...
const EditProfile = () => {
    ...
    const [inputBoxWorkingDaysValue, setInputBoxWorkingDaysValue] = useState<any>("");
            ...
            >
                <div className="flex flex-col gap-3">
                    ...
                    {!showInputBoxSalary &&
                        <div className="flex flex-col p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FAFAFA] rounded">
                            <div className="flex items-center gap-3">
                                <p className="text-sm font-semibold text-[#2E2E2E] tracking-[0.25px]">Salary</p>
                                <img src={edit} onClick={() => {
                                    setShowInputBoxSalary(!showInputBoxSalary);
                                }} className="w-3 h-3" alt="" />
                            </div>
                            <div>
                                <p className="text-[12px] leading-5 font-normal text-[#1C1C1C] tracking-[0.25px]">{singleEmployee.salary}</p>
                            </div>
                        </div >}
                    {showInputBoxSalary &&
                        <div className="flex justify-between p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FFFFFF] rounded">
                            <div className="flex flex-col">
                                <div className="flex gap-3">
                                    <p className="text-sm font-semibold text-[#283093] tracking-[0.25px]">Salary</p>
                                </div>
                                <div>
                                    <input
                                        ...
                                        onChange={(event) => setInputBoxSalaryValue(event.target.value)}
                                        type="number" />
                                </div>
                            </div>
                            <div className="flex justify-center items-center">
                    ...
                    {!showInputBoxLunchTime &&
                        <div className="flex flex-col p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FAFAFA] rounded">
                            <div className="flex items-center gap-3">
                                <p className="text-sm font-semibold text-[#2E2E2E] tracking-[0.25px]">Lunch Time</p>
                                <img src={edit} onClick={() => {
                    ...
                    {!showInputBoxWorkingDays &&
                        <div className="flex flex-col p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FAFAFA] rounded">
                            <div className="flex items-center gap-3">
                                <p className="text-sm font-semibold text-[#2E2E2E] tracking-[0.25px]">Working Days</p>
                                <img src={edit} onClick={() => {
                    ...
                    {!showInputBoxWorkingHours &&
                        <div className="flex flex-col p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FAFAFA] rounded">
                            <div className="flex items-center gap-3">
                                <p className="text-sm font-semibold text-[#2E2E2E] tracking-[0.25px]">Working Hours</p>
                                <img src={edit} onClick={() => {
                    ...
                    {showInputBoxWorkingHours &&
                        <div className="flex justify-between p-4 w-[448px] border border-solid border-[#DEDEDE] bg-[#FFFFFF] rounded">
                            <div className="flex flex-col">
                                <div className="flex gap-3">
                                    <p className="text-sm font-semibold text-[#283093] tracking-[0.25px]">Working Hours</p>
                                </div>
                                <div>
                                    <input
                                        ...
                                        onChange={(event) => setInputBoxWorkingHoursValue(event.target.value)}
                                        type="number" />
                                </div>
                            </div>
                            <div className="flex justify-center items-center">
