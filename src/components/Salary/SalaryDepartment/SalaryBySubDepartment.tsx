                    ...
                    <td className="py-4 px-5 text-sm font-normal text-[#2E2E2E] whitespace-nowrap border-r border-b border-solid border-[#EBEBEB]">
                      {element.salaryData
                        .reduce(
                          (acc: any, job: any) =>
                            acc +
                            (job.employeeTotalHours -
                              (job.employeePendingHours +
                                job.employeeWorkingHours)),
                          0
                        )
                        .toFixed(2)}
                    </td>
